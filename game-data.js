...
window.PTUX_GAME_DATA = [
  {
    ...
    tasks: [
      ...
      { id: 'P1_A2', title: 'Mit SSH am Remote-Server anmelden', description: 'Melde dich mit einem der von der ptuX-KI angezeigten Superuser-Konten auf einem installierten Server an.', hint: 'Nutze ssh <benutzername>@<hostname> und gib das dazu angezeigte Passwort an der Passwortabfrage ein.', command: 'ssh', goal: 'SSH-Anmeldung erfolgreich' },
